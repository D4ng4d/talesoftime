...
def backup_sqlite_db():
    """
    Creates a timestamped backup of the SQLite database using the official SQLite backup API.
    """
    ...
    try:
        ...
        print(f'FALED: Backup error: {str(e)}')
        return None
...
if __name__ == "__main__":
    try:
        ...
        #Initialise the app and run the backup within its context
        ...
        print("Make sure this script in the root folder alongside app.py")
    except Exception as e:
