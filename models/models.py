...
def get_db() -> sqlite3.Connection:
    ...
    all query results behave like dicts (ro["ColumnName"]).

    Cakkers are responsible for closing the connection, or using
...
def init_db() -> None:
    """
    Execute the schema DDL agaisnt the database.
