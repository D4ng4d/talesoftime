...
CREATE TABLE IF NOT EXISTS Quest (
    ...
    DifficultyID INTEGER NOT NULL REFERENCES Difficulty(DifiicultyID)
);
...
CREATE TABLE IF NOT EXISTS Inventory (
    ...
    ItemID INTEGER NOT NULL REFERENCES Iten(ItemID),
    Quantity INTEGER NOT NULL DEFAULT 1
);

CREATE TABLE IF NOT EXISTS CharacterQuest (
    CharacterQuestID INTEGER PRIMARY KEY AUTOINCREMENT,
    CharacterID INTEGER NOT NULL REFERENCES CHaracter(CharacterID) IN DELETE CASCADE,
